...
public:
    static bool hasInternetConnection()
    {
        ...
        if (! cocos2d::JniHelper::getStaticMethodInfo(methodInfo, "org/cocos2dx/javascript/Connectivity", "isConnectedToInternet", "()Z")) {
            return false;
        }
    ...
    static bool isConnectionFast()
    {
        ...
        if (! cocos2d::JniHelper::getStaticMethodInfo(methodInfo, "org/cocos2d/javascript/Connectivity", "isConnectionTypeFast", "()Z")) {
            return false;
        }
    ...
    static bool isConnectionTypeMobile()
    {
        ...
        if (! cocos2d::JniHelper::getStaticMethodInfo(methodInfo, "org/cocos2d/javascript/Connectivity", "isConnectionTypeMobile", "()Z")) {
            return false;
        }
